...
#define WITH_MODULES
#endif
#define LIBXSLT_DEFAULT_PLUGINS_PATH() "/opt/workspace/momentum/vendor/ruby/2.1.0/gems/nokogiri-1.6.1/ports/x86_64-apple-darwin12.5.0/libxslt/1.1.26/lib/libxslt-plugins"
#endif
